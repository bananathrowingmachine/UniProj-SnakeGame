...
public sealed class HttpNetworkConnection : IDisposable
{
    /// <summary>
    ...
    /// <summary>
    ///   Initializes a new instance of the <see cref="HttpNetworkConnection"/> class.
    ///   <para>
    ...
    /// </param>
    public HttpNetworkConnection(TcpClient tcpClient)
    {
